...
def email():
    return (
        "".join(
            random.choices(
                string.ascii_lowercase + string.digits, k=random.choice(range(6, 23))
            )
        )
        + "@"
        + "".join(
            random.choice(
                ["gmail", "protonmail", "yahoo", "mail",
                    "libero", "hotmail", "live"]
            )
        )
        + random.choice(
...
def username(max=23):
    return "".join(random.choices(string.ascii_lowercase + string.digits, k=random.choice(range(6, max))))


def password(min=6, max=23):
    return "".join(
        random.choices(
            string.ascii_letters + string.digits,
            k=random.choice(range(min, max)),
        )
    )
